...
scp -i ~/Downloads/MyKeyPair.pem -o stricthostkeychecking=no DistributedEC2Sorting-0.0.1-SNAPSHOT-jar-with-dependencies.jar ubuntu@ec2-52-91-224-157.compute-1.amazonaws.com:~/Project
scp -i ~/Downloads/MyKeyPair.pem -o stricthostkeychecking=no DistributedEC2Sorting-0.0.1-SNAPSHOT-jar-with-dependencies.jar ubuntu@ec2-52-23-181-215.compute-1.amazonaws.com:~/Project
scp -i ~/Downloads/MyKeyPair.pem -o stricthostkeychecking=no DistributedEC2Sorting-0.0.1-SNAPSHOT-jar-with-dependencies.jar ubuntu@ec2-54-165-239-15.compute-1.amazonaws.com:~/Project
scp -i ~/Downloads/MyKeyPair.pem -o stricthostkeychecking=no DistributedEC2Sorting-0.0.1-SNAPSHOT-jar-with-dependencies.jar ubuntu@ec2-52-90-105-55.compute-1.amazonaws.com:~/Project	
